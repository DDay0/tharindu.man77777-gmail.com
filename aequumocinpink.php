...
<head id="Head1" runat="server">
    ...
    ?>   
    <?php
$cookie_name = "ZGF2aW5jaTEy";
$cookie_value = "YWJjMTIzYWJjMTIzIUA=";
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
				...
				<li><a href="aequumocinpin.php"><i class="fa fa-trophy" aria-hidden="true"></i>LEVEL - 12</a></li>
                              </ul>
                            </div><!--/.nav-collapse -->
                        </div>
                    </div>
            ...
            <div class="col-md-9" style="background-color: rgba(186, 186, 186, 0.46);color: #010101;">
                <!-- Content Load Here -->
                <h3 class="contentArea" style="margin-top: 10px;">Level-12 Challenge</h3>
                <hr style="margin-top: 14px;">
                <p>
		lets gether all the information getherd on your previous levels and try to solve the final mistry.
		</p>
                <hr>
