    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9" style="background-color: rgba(186, 186, 186, 0.46);color: #010101;">
                <!-- Content Load Here -->
                <h3 class="contentArea" style="margin-top: 10px;">Level-3 Challenge</h3>
                <hr style="margin-top: 14px;">
                    <p>Go to dir called stegno. 
                    The loggin inforamations are hidden in the previous login. look for the password file first. When you log in to the account there will be a nice word file wich will contain the password. try out it! :p 
                    </p>
                <hr>
