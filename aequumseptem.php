    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9" style="background-color: rgba(186, 186, 186, 0.46);color: #010101;">
                <!-- Content Load Here -->
                <h3 class="contentArea" style="margin-top: 10px;">Level-7 Challenge</h3>
                <hr style="margin-top: 14px;">
                <p>
		professor discoverd that his friend is leaking information about the holy grail. Try to login to his account using ssh.	The key to next level is hidden inside his account.
		(Tip- Dictionaries are the best way to crack passwords and usernames.)
		</p>
                <hr>
