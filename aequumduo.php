    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9" style="background-color: rgba(186, 186, 186, 0.46);color: #010101;">
                <!-- Content Load Here -->
                <h3 class="contentArea" style="margin-top: 10px;">Level-2 Challenge</h3>
                <hr style="margin-top: 14px;">
                    <p>Here you have to use your linux skills to get through the level. look for the ile system in your given location for unusual files </p>
                <hr>
